...
function ChemSection({
  ...
  return (
    <div>
      <h3 className="mb-2 text-xs font-semibold text-gray-500">{label}</h3>
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6">
        ...
        <nav className="mb-6 flex flex-wrap items-center gap-2 text-sm text-gray-400">
          ...
          <span>›</span>
          <span className="text-gray-700">{titolo}</span>
        </nav>
          ...
          <div className="space-y-6">
            <section className="rounded-xl border border-gray-200 p-5">
              ...
              {!stampa.dataStampa && !stampa.carta && !stampa.formatoStampa && (
                <p className="text-sm text-gray-400">Nessun dato inserito</p>
              )}
            </section>
          ...
          <div className="space-y-6">
            ...
            {(stampa.interventi || stampa.note) && (
              <section className="rounded-xl border border-gray-200 p-5">
                ...
                {stampa.interventi && (
                  <div className="mb-3">
                    <p className="mb-1 text-xs text-gray-400">Interventi</p>
                    <p className="text-sm text-gray-800 whitespace-pre-wrap">{stampa.interventi}</p>
                  </div>
                )}
                {stampa.note && (
                  <div>
                    <p className="mb-1 text-xs text-gray-400">Note</p>
                    <p className="text-sm text-gray-800 whitespace-pre-wrap">{stampa.note}</p>
                  </div>
                )}
              </section>
            )}
