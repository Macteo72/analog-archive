    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6">
        ...
        <nav className="mb-6 flex items-center gap-2 text-sm text-gray-400">
          ...
          <span>›</span>
          <span className="text-gray-700">Rullino {rullino.codiceArchivio}</span>
        </nav>
        ...
        <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-lg text-gray-600">{rullino.pellicola}</p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <section className="rounded-xl border border-gray-200 p-5">
            ...
            <dl className="space-y-2">
              ...
              {rullino.scene && (
                <div className="pt-1">
                  <dt className="mb-1 text-sm text-gray-400">Scene</dt>
                  <dd className="text-sm text-gray-800 whitespace-pre-wrap">{rullino.scene}</dd>
                </div>
              )}
            </dl>
          </section>
            ...
            <dl className="space-y-2">
              ...
              {rullino.noteSviluppo && (
                <div className="pt-1">
                  ...
                  <dd className="text-sm text-gray-800 whitespace-pre-wrap">{rullino.noteSviluppo}</dd>
                </div>
              )}
              {!rullino.prodottoSviluppo && !rullino.diluizione && !rullino.tempoSviluppo && !rullino.dataSviluppo && (
                <p className="text-sm text-gray-400">Nessun dato di sviluppo inserito</p>
              )}
            </dl>
          </section>
        </div>
              ...
              {rullino.negativi.map((neg) => (
                ...
                >
                  ...
                  <span className="text-sm text-gray-800">
                    {neg.scena ?? <span className="text-gray-400 italic">Senza titolo</span>}
                  </span>
