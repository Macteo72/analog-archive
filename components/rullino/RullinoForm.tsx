          ...
          <Field label="Provino a contatto" name="provinoContatto">
            <div className="flex h-10 items-center">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 dark:border-gray-600 accent-gray-900 dark:accent-white"
              />
              <label htmlFor="provinoContatto" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Sì, realizzato
              </label>
            </div>
          </Field>
